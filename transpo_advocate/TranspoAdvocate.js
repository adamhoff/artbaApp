...
export default class Newsline extends React.Component {
  ...
  componentDidMount(){
    return fetch('https://transportationinvestment.org/wp-json/feed/v1/posts')
  ...
  goToDetails = () => {
    this.props.navigation.navigate("TranspoAdvocateDetails");
  };
    ...
    return(
      <View style={styles.container, styles.background}>
        <FlatList
          ...
          <View style={styles.container}>
            <TouchableHighlight
              onPress={() => this.props.navigation.navigate("TranspoAdvocateDetails", item: item)}
              activeOpacity={1}
